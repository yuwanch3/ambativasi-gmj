  ...
  const navigasiKeReview = async () => {
    try {
      ...
      router.push({
        ...
        params: { 
          judul_bab: String(judul_bab || "Ujian Bahasa Jepang Bab 1"), 
  ...
  if (loadingSession || loadingAI) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.teksLoading}>Sedang meracik 50 butir soal Ujian Bahasa Jepang Bab 1...</Text>
      </View>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.mainContent}>
        ...
        <Text style={styles.sectionTitle}>{judul_bab || "Ujian Bahasa Jepang Bab 1"}</Text>
