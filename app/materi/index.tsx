...
// 💡 ONLINE: Pastikan alamat terowongan Ngrok ini selalu sama dengan yang aktif ya!
          ...
          {levels.map((level) => (
            ...
            >
              <View style={styles.levelCardLeft}>
                ...
                >
                  <Text style={[styles.levelBadgeText, { color: colors.isDark ? "#4ADE80" : "#16A34A" }]}>
                    {level.id}
                  </Text>
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={[styles.levelTitle, { color: colors.text }]}>{level.judul}</Text>
                  <Text style={[styles.levelSubtitle, { color: colors.subtext }]} numberOfLines={1}>
                    {level.sub}
                  </Text>
                </View>
              </View>
