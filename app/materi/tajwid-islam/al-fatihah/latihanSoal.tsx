  ...
  const navigasiKeReview = async () => {
    try {
      ...
      router.push({
        ...
        params: { 
          judul_bab: String(judul_bab || "Tajwid - Surah Al-Fatihah"), 
  ...
  if (loadingSession || loadingAI) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.teksLoading}>Sedang meracik 10 butir soal Tajwid Al-Fatihah via AI...</Text>
      </View>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.mainContent}>
        ...
        <Text style={styles.sectionTitle}>{judul_bab || "Tajwid - Surah Al-Fatihah"}</Text>
