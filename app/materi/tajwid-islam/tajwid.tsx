  ...
  const checkSession = async () => {
    try {
      ...
      if (session === null) {
        ...
        // 💡 AMBIL FOTO PROFIL: Sinkronisasi instan dari database API PHP kamu
        try {
  ...
  const levels = [
    {
      id: 1,
      judul: "Al-Fatihah",
      sub: "Penjelasan Sub Materi Untuk Surah Al-fatihah",
      path: "/materi/tajwid-islam/al-fatihah/materiAl-fatihah",
    },
  ];
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.mainContent}>
        ...
        >
          ...
          <Text style={styles.backButtonText}>Kembali ke Bahasa Jepang</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.sectionTitle}>Pilih Tingkatan</Text>
